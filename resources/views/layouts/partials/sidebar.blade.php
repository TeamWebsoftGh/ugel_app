    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown {{ (request()->is('*payments*')||request()->is('*offers*')||request()->is('*service-types*')) ? 'show' : '' }}" id="operations">
            <ul class="nav nav-sm flex-column">
                ...
                <li class="nav-item">
                    <a href="{{route("offers.queued")}}" class="nav-link" data-key="t-user_activity"> Lease Properties </a>
                </li>
                <li class="nav-item">
                    <a href="{{route("offers.active")}}" class="nav-link" data-key="t-user_activity">Property Units </a>
                </li>
                <li class="nav-item">
