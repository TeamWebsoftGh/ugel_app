...
@section('content')
    <div class="row">
        <div class="col-sm-12 col-md-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Quick Sms Details</h4>
                    <p class="card-subtitle mb-4"></p>
                    <div id="product-content">
                        <form method="POST" action="{{route('bulk-sms.quick')}}" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <textarea class="form-control" rows="3" maxlength="160" name="short_message" id="short_message">{!! $sms->short_message  !!}</textarea>
                                            @error('short_message')
                                            <span class="input-note text-danger">{{ $message }} </span>
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        @can('create-'.get_permission_name())
