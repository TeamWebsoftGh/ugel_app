...
@section('title', 'ImportRequest Electoral Areas')
@section('page-title', 'Electoral Areas')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">The correct column order is (Name,Code,Region) and you must follow the csv file,
                        otherwise you will get an error while importing the csv file.</p>
                    <h6><a href="{{asset('sample_file/sample_electoral_areas.csv')}}" class="btn btn-primary"> <i
                                class="fa fa-download"></i> {{__('Download sample File')}} </a></h6>
                    <hr/>
                    <form action="{{ route('electoral-areas.importPost') }}" name="import_employee" id="import_employee" autocomplete="off" enctype="multipart/form-data"
