...
/* Masthead ----------------------- */
'email-masthead' => 'padding: 0px 0; text-align: center;',
...
<!--{{ config('app.name') }}-->
</a><div align="center"><h5>{{strtoupper(settings('app_name', config('app.name')))}}</h5></div></td>
</tr>
<!-- Email Body -->
<tr>
<td style="{{ $style['email-body'] }}" width="100%"><table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
<tr>
<td align="center" style="padding: 20px;font-size: 22px;text-align: left;">
...
<tr>
<td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}"><p style="{{ $style['paragraph-sub'] }}"> &copy; {{ date('Y') }} <a style="{{ $style['anchor'] }}" href="{{ url('/') }}" target="_blank">{{settings('app_name', config('app.name'))}}</a>.
