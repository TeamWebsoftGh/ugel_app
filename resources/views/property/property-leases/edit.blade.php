<form method="POST" id="property_lease" action="{{route('property-leases.store')}}" >
    <p>All fields with <span class="text-danger">*</span> are required.</p>
    @csrf
    <input type="hidden" id="_id" name="id" value="{{$property_lease->id}}">
    ...
    <div class="row">
        ...
        <div class="form-group col-6 col-md-4">
            ...
            <input type="text" name="short_name" id="short_name" required class="form-control"
                   placeholder="short_name" value="{{old('name', $property_lease->short_name)}}">
