...
@section('title', 'Loan Transactions Report')
@section('page-title', 'Loan Transactions Report')
        ...
        <div class="col-12">
            <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Loan Transactions Report</h4>
                ...
                <div class="card-body">
                    @include("admin.report.partials.loan-transactions-report")
                </div> <!-- .card-body-->
            </div>
        </div>
    </div>
