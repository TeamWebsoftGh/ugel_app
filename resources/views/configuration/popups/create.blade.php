...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('admin.configurations.popups.index')}}">Popups</a></li>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if($errors->all())
                        ...
                        @endforeach
                    @endif
                    <form method="post" id="needs-validation" novalidate action="{{route("admin.configurations.popups.store")}}" enctype="multipart/form-data">
                        @csrf
