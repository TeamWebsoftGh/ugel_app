...
@section('button')
    <a class='btn btn-info text-white px-4 align-self-center report-btn' href="{{route('admin.configurations.popups.create')}}">Add Popup</a>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-white">
                    <h4 class="card-title">
                        Popups
                        @if(user('admin')->hasPermission('create-announcements'))
                            <span style="float: right"><a href="{{route('admin.configurations.popups.create')}}" class="btn btn-primary">Add Popup</a></span>
                        @endif
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <table id="basic-datatable" class="table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            @forelse($popups as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route("admin.configurations.popups.show", $data->id)}}" class="btn btn-sm btn-info text-white show_modal_demo"
                                           data-type="{{$data->type}}"
                                        ...
                                        <a href="{{route("admin.configurations.popups.edit", $data->id)}}" class="btn btn-sm btn-success text-white"><i class="mdi mdi-file-edit"></i></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form method="POST" action="{{ route('admin.configurations.popups.destroy', $data->id) }}">
                                                    @csrf
                                                    @method('DELETE')
