        ...
        <div class="col-md-12 ">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="knowledge_base-table" class="table dt-responsive" style="box-shadow: none">
                        <thead>
                        <tr>
    ...
    <script>
        (function($) {
            ...
            $(document).ready(function () {
                ...
                loadDataAndInitializeDataTable("knowledge_base", "{{ route('resource.knowledge-base.index') }}", cols);
            });
        })(jQuery);
    </script>
@endsection
