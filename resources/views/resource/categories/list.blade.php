        ...
        @forelse($categories as $category)
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-sm btn-danger" onclick="DeleteItem('{{$category->name}}', '{{route('tasks.categories.destroy', $category->id)}}')" href="#"><i class="fa fa-trash"></i> Delete</a>
                </td>
            </tr>
        @empty
        @endforelse
