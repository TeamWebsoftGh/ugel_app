...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('organization.subsidiaries.index')}}">Companies</a></li>
@endsection
        ...
        <div class="col-sm-8 col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="list-content">
                        @include("organization.companies.edit")
                    </div>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
        </div> <!-- end col -->
        ...
        (function($) {
            ...
            $(document).ready(function () {
                let oTable = $('#mini-datab').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('organization.companies.index') }}",
                    },
                    columns: [
