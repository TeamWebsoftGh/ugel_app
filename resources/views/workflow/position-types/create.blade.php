...
@section('title', 'Manage Position Types')
@section('page-title', 'Position Types')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('workflows.position-types.index')}}">Position Types</a></li>
@endsection
...
{{--                    <p class="card-subtitle mb-4"></p>--}}
        ...
        <div class="col-md-8 ">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Position Type Details</h4>
                    <p class="card-subtitle mb-4"></p>
                    <div id="wf_position-content">
                        @include("workflow.position-types.edit")
                    </div>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
        </div> <!-- end col -->
        ...
        (function($) {
            ...
            $(document).ready(function () {
                let oTable = $('#mini-workflow_position').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('workflows.position-types.index') }}",
                    },
                    columns: [
