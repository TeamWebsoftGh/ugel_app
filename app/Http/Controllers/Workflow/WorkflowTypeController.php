...
class WorkflowTypeController extends Controller
{
    ...
    {
        $this->middleware(['permission:create-workflow-types|update-workflow-types'], ['only' => ['create', 'store']]);
        $this->middleware(['permission:delete-workflow-types'], ['only' => ['destroy', 'delete_by_selection']]);
        $this->middleware(['permission:read-workflow-types'], ['only' => ['index', 'show']]);
