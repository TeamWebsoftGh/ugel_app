...
class BulkVoiceController extends \App\Http\Controllers\Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('memo.bulk-voice.index', compact('announcements', 'data'));
    }
    ...
    public function create()
    {
        ...
        return view('memo.bulk-voice.create', compact('announcement'));
    }
    ...
    public function quickVoice()
    {
        ...
        return view('memo.bulk-voice.quick', compact('sms', 'contact_groups'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($request->ajax()){
            return view('memo.bulk-voice.show', compact('announcement'));
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($request->ajax()){
            return view('memo.bulk-voice.edit', compact('announcement'));
        }
