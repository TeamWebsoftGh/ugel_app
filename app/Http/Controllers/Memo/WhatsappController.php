...
class WhatsappController extends \App\Http\Controllers\Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('memo.whatsapp.index', compact('announcements', 'data'));
    }
    ...
    public function create()
    {
        ...
        return view('memo.whatsapp.create', compact('announcement', 'tem_types'));
    }
    ...
    public function quickWhatsApp()
    {
        ...
        return view('memo.whatsapp.quick', compact('sms', 'contact_groups', 'tem_types'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($request->ajax()){
            return view('memo.whatsapp.show', compact('announcement'));
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($request->ajax()){
            return view('memo.whatsapp.edit', compact('announcement'));
        }

        return view('memo.whatsapp.create', compact('announcement'));
    }
