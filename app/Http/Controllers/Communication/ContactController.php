...
class ContactController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('communication.contacts.index');
    }
    ...
    public function create()
    {
        ...
        if (request()->ajax()){
            return view('communication.contacts.edit', compact('contact', 'contact_groups'));
        }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($request->ajax()){
            return view('communication.contacts.show', compact('contact', 'contact_groups'));
        }
    ...
    {
        return view('communication.contacts.import');
    }
