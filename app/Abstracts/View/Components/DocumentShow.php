...
abstract class DocumentShow extends Base
{
    ...
    public function __construct(
        ...
        bool $hideItems = false, bool $hideName = false, bool $hideDescription = false, bool $hideQuantity = false, bool $hideDuration = false, bool $hidePrice = false, bool $hideDiscount = false, bool $hideAmount = false, bool $hideNote = false, bool $hideAttachment = false,
        string $textItems = '', string $textQuantity = '', string $textDuration = '', string $textPrice = '', string $textAmount = '', $attachment = [],
