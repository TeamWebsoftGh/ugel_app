...
class EmployeeService extends ServiceBase implements IEmployeeService
{
    use UploadableTrait;
     ...
     */
    public function __construct(IEmployeeRepository $employeeRepository, IUserRepository $userRepository)
    {
        parent::__construct();
     ...
     * @return Collection
     */
    public function listPastEmployees(array $filter = [], string $order = 'updated_at', string $sort = 'desc'): Collection
    {
        return $this->employeeRepo->listExitedEmployees($filter, $order, $sort);
    }
    ...
    public function createEmployee(array $params): Response
    {
        ...
        try {
            ...
            event(new NewEmployeeEvent($created_user));
    ...
    public function updateEmployee(array $data, Employee $employee)
    {
        ...
        try {
            ...
            DB::beginTransaction();
            $result = $this->employeeRepo->updateEmployee($data, $employee);
