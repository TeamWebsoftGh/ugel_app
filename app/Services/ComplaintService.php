...
class ComplaintService extends ServiceBase implements IComplaintService
{
    ...
    public function createComplaint(array $params)
    {
        ...
        try {
            ...
            log_error(format_exception($e), new Complaint(), 'create-properties-failed');
        }
        ...
        //Audit Trail
        $logAction = 'create-properties-successful';
    ...
    public function updateComplaint(array $params, Complaint $complaint)
    {
        ...
        try {
            ...
            log_error(format_exception($e), $complaint, 'update-properties-failed');
        }
        ...
        //Audit Trail
        $logAction = 'update-properties-successful';
    ...
    public function deleteComplaint(Complaint $complaint)
    {
        ...
        try{
            ...
            log_error(format_exception($ex), $complaint, 'create-properties-failed');
        }
        ...
        //Audit Trail
        $logAction = 'delete-properties-successful';
