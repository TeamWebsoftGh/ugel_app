  ...
  */
  ...
  var Editor = function (context) {
    ...
    this.initialize = function () {
      ...
      // [workaround] IE doesn't have input calendar for contentEditable
   ...
   *  mouse calendar that show/hide popover will be handled by Handle.js.
   *  Handle.js will receive the calendar and invoke 'imagePopover.update'.
   */
